...
<script type="text/javascript">
	...
	function fn_createBoard2(){
		location.href = "${context}/work/board/createBoard4.do";
	}
				                    	...
				                    	<c:forEach items="${dsBoardList}" var="dsBoardList" varStatus="courseIdx">
				                         <tr>
				                         	<td style="vertical-align: middle;">
				                         		<div class="col-md-7"><a href ="${context}/work/board/retrieveBoard4.do?boardNo=${dsBoardList.BOARD_NO}"><font size="5px">${dsBoardList.BOARD_TITLE}</font></a></div>
