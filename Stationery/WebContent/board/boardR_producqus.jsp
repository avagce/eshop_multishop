...
<head>
	...
	function fn_delete2(){
		...
		if(confirm("정말 글을 삭제하시겠습니까?")){
			location.href = "${context}/work/board/deleteBoard5.do?boardNo=" + boardNo;
		}
	}
	...
	function fn_update2(){
		...
		location.href = "${context}/work/board/updateBoard4.do?boardNo=" + boardNo;
	}
	...
	//목록으로
	function fn_moveToBoard2(){
		location.href = "${context}/work/board/retrieveBoardList4.do";
	}
</script>
<style type="text/css">
li{
