...
<script type="text/javascript">
	...
	function fn_createBoard2(){
		location.href = "${context}/work/board/createBoard3.do";
	}
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="page-header" style="float: right;">
					  <button type="button" class="btn btn-success btn-lg" onclick="fn_createBoard3()">새 글 쓰기</button>
				</div>
			</div>
				                    	...
				                    	<c:forEach items="${dsBoardList}" var="dsBoardList" varStatus="courseIdx">
				                         <tr>
				                         	<td style="vertical-align: middle;">
				                         		<div class="col-md-7"><a href ="${context}/work/board/retrieveBoard3.do?boardNo=${dsBoardList.BOARD_NO}"><font size="5px">${dsBoardList.BOARD_TITLE}</font></a></div>
