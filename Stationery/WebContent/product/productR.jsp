            ...
            <div class="panel-body">
              <div class="row">
                ...
                <br><br><br>
                  ...
                  <br><br>
                  <div>
                	  <button id ="buyBtn" type="button" class="btn btn-primary btn-lg" onclick="location.href='${context}/sping/introduction.jsp'"><i class="fa fa-credit-card fa-2x">&nbsp;바로구매</i></button>
